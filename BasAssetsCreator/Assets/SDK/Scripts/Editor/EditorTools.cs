...
public class EditorTools : EditorWindow
{
    ...
    Vector3 scroll0,scroll1,scroll2,scroll3;
    private void OnGUI()
    {
        //Separator
        GUILayout.Space(10);
    ...
    private void AssetBuilderMenu()
    {
        ...
        foreach (string bundle in bundleNames)
        {
            ...
            EditorGUI.BeginDisabledGroup(streamingassetsDirectory == null || streamingassetsDirectory == "" || streamingassetsDirectory.Substring(streamingassetsDirectory.LastIndexOf('/') + 1, streamingassetsDirectory.Length - streamingassetsDirectory.LastIndexOf('/') - 1) != "StreamingAssets");
