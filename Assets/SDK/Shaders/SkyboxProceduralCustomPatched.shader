Shader "ThunderRoad/SkyboxProceduralCustomPatched"
{
    Properties
    {
        ...
        _HorizonMin ("Horizon Min fade distance", Range(-50,0)) = -20
        _HorizonMax ("Horizon Max fade distance", Range(0,50)) = 10

        _Exposure("Exposure", Range(0, 8)) = 1.3

        //[Feature(_TONEMAPPING)]HeaderTonemapping("# Tonemapping", Int) = 0
        [Toggle(_TONEMAPPING_ON)] _TONEMAPPING("Use Tonemapping", Float) = 1
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_local __ _TONEMAPPING_ON
            ...
            uniform float _HorizonMin;
            uniform float _HorizonMax;
            uniform half _AtmosphereThickness;
            CBUFFER_END
        
            half4 _TonemappingSettings;
           ...
           #define LINEAR_2_OUTPUT(color) sqrt(color)
            ...
            half4 frag(v2f IN) : SV_Target
            {
               ...
               half y = ray.y / SKY_GROUND_THRESHOLD;
                ...
                float l = (y - _HorizonMin) / (_HorizonMax - _HorizonMin);
                if(y < _HorizonMax && y > _HorizonMin)
                {
                    col *= lerp(half3(1,1,1), _HorizonColor, sin(l * 3.141592653589793));
                }
               ...
               if(y < 0.0)
               {
                ...
                #if _TONEMAPPING_ON
                    //col.rgb = ApplyTonemap(col.rgb, _TonemappingSettings);
                #endif
