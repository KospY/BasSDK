	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = saturate( ( ( ( appendResult42 * float4( (( ( IN.ase_color.a * _TextureIntensity ) * tex2DNode5 )).rgb , 0.0 ) ) * tex2DNode5.a ) + temp_output_53_0 ) ).xyz;
				float Alpha = temp_output_53_0.x;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = temp_output_53_0.x;
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1234.035,-803.4031;Inherit;True;Property;_TextureIntensity;Texture Intensity;3;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
