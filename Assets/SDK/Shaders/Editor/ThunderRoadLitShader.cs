...
public class ThunderRoadLitShader : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        MaterialProperty alphaStrength = ShaderGUI.FindProperty("_AlphaStrength", properties);
        ...
        MaterialProperty vertexColorIntensity = ShaderGUI.FindProperty("_VertexColorIntensity", properties);
        ...
        materialEditor.ShaderProperty(alphaStrength, alphaStrength.displayName);
        ...
        materialEditor.ShaderProperty(vertexColorIntensity, vertexColorIntensity.displayName);
