...
Shader "ThunderRoad/VFX/vfx_fake_bloom_additive_HD"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_53_0 = ( ( ( _BloomColor * tex2DNode6 ) * ( tex2DNode6.a * _BloomIntensity ) ) * IN.ase_color.a );
				...
				float distanceDepth62 = saturate( abs( ( screenDepth62 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _SoftParticle ) ) );
				float4 temp_output_60_0 = ( ( ( ( appendResult42 * float4( (( ( IN.ase_color.a * _TextureIntensity ) * tex2DNode5 )).rgb , 0.0 ) ) * tex2DNode5.a ) + temp_output_53_0 ) * distanceDepth62 );
				float3 temp_output_14_0_g2910 = temp_output_60_0.xyz;
				float3 desaturateInitialColor46_g2910 = temp_output_14_0_g2910;
				float desaturateDot46_g2910 = dot( desaturateInitialColor46_g2910, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar46_g2910 = lerp( desaturateInitialColor46_g2910, desaturateDot46_g2910.xxx, 0.2 );
				...
				#endif
				float4 temp_output_1_0_g2910 = staticSwitch215_g2828;
				float3 FogRGB6_g2910 = (temp_output_1_0_g2910).xyz;
				...
				#endif
				float3 temp_output_2_0_g2910 = staticSwitch212_g2828;
				float3 hsvTorgb48_g2910 = RGBToHSV( ( FogRGB6_g2910 * temp_output_2_0_g2910 ) );
				float clampResult51_g2910 = clamp( hsvTorgb48_g2910.y , 0.0 , 0.8 );
				float3 hsvTorgb49_g2910 = HSVToRGB( float3(hsvTorgb48_g2910.x,clampResult51_g2910,1.0) );
				float3 temp_output_42_0_g2910 = saturate( hsvTorgb49_g2910 );
				float DepthMask5_g2910 = (temp_output_1_0_g2910).w;
				float3 lerpResult7_g2910 = lerp( ( desaturateVar46_g2910 * temp_output_42_0_g2910 ) , float3(0,0,0) , DepthMask5_g2910);
				float grayscale66 = (temp_output_53_0.rgb.r + temp_output_53_0.rgb.g + temp_output_53_0.rgb.b) / 3;
				float temp_output_31_0_g2910 = grayscale66;
				float3 lerpResult34_g2910 = lerp( float3( 0,0,0 ) , lerpResult7_g2910 , temp_output_31_0_g2910);
				float temp_output_27_0_g2910 = ( 1.0 - DepthMask5_g2910 );
				#ifdef _USEUNDERWATER
				float3 staticSwitch37_g2910 = ( lerpResult34_g2910 * temp_output_27_0_g2910 );
				#else
				float3 staticSwitch37_g2910 = temp_output_14_0_g2910;
				#endif
				float3 temp_output_3_0_g2881 = staticSwitch37_g2910;
				float3 color7_g2881 = temp_output_3_0_g2881;
				float3 localApplyTonemapper7_g2881 = ApplyTonemapper( settings7_g2881 , color7_g2881 );
				
				#ifdef _USEUNDERWATER
				float staticSwitch38_g2910 = ( temp_output_27_0_g2910 * temp_output_31_0_g2910 );
				#else
				float staticSwitch38_g2910 = temp_output_31_0_g2910;
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = localApplyTonemapper7_g2881;
				float Alpha = staticSwitch38_g2910;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = staticSwitch38_g2910;
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1234.035,-803.4031;Inherit;True;Property;_TextureIntensity;Texture Intensity;7;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1065.519,493.1418;Inherit;True;Property;_BloomIntensity;Bloom Intensity;5;0;Create;True;0;0;0;False;0;False;0;0.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;18;-965.3866,-157.5219;Inherit;False;Property;_BloomColor;Bloom Color;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.2264842,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;1074.639,11.37601;Inherit;False;Property;_SoftParticle;Soft Particle;8;0;Create;True;0;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;62;1215.089,-79.17043;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;1393.028,-229.7343;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;63;1632,-144;Inherit;False;CausticsAndFog;9;;2828;faa94743a70a11f47a63fa5c9cf350f2;16,175,0,230,0,246,0,236,0,216,0,162,0,370,0,237,0,387,1,384,1,388,1,15,0,100,0,171,0,168,1,13,0;10;253;FLOAT3;0,0,0;False;263;FLOAT3;0,0,0;False;245;FLOAT;0;False;67;FLOAT;0;False;195;FLOAT3;0,0,0;False;23;FLOAT;0;False;11;FLOAT3;1,1,1;False;10;FLOAT3;0,0,0;False;9;FLOAT3;0,0,1;False;57;FLOAT;0;False;6;FLOAT3;266;FLOAT3;0;FLOAT3;8;FLOAT4;25;FLOAT;243;FLOAT3;167
Node;AmplifyShaderEditor.TFHCGrayscale;66;1696,144;Inherit;False;2;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;64;2272,-96;Inherit;False;TonemappingNode;2;;2881;305ac1d3fd2773448b8bd3815ea5531e;1,6,1;2;3;FLOAT3;0,0,0;False;4;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;69;1984,-64;Inherit;False;ApplyFogAndTint;-1;;2910;6bb817da436f9a84da1721b331a80851;5,32,1,16,0,35,1,45,1,39,1;5;14;FLOAT3;0,0,0;False;17;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT3;1,1,1;False;31;FLOAT;1;False;2;FLOAT3;0;FLOAT;25
...
WireConnection;69;14;60;0
WireConnection;69;1;63;25
WireConnection;69;2;63;167
WireConnection;69;31;66;0
WireConnection;29;2;64;0
WireConnection;29;3;69;25
ASEEND*/
//CHKSM=D7A173D468A27684E7F638C47846F9EB344E7A51