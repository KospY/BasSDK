...
Shader "ThunderRoad/VFX/vfx_fake_bloom_additive_HD"
{
	Properties
	{
		...
		[ASEEnd]_SoftParticle("Soft Particle", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = saturate( ( ( ( ( appendResult42 * float4( (( ( IN.ase_color.a * _TextureIntensity ) * tex2DNode5 )).rgb , 0.0 ) ) * tex2DNode5.a ) + temp_output_53_0 ) * distanceDepth62 ) ).xyz;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = temp_output_53_0.r;
...
Node;AmplifyShaderEditor.RangedFloatNode;61;1074.639,11.37601;Inherit;False;Property;_SoftParticle;Soft Particle;5;0;Create;True;0;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=95929CAC76914EFDE446F6C52BBF15E3493D7C95