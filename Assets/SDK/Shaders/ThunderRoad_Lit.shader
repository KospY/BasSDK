...
Shader "ThunderRoad/Lit_DONOTUSE_USE_TRLitMoss_Instead"
{
   Properties
   {
...
ZWrite On
   ...
   #pragma fragment Frag
            ...
            #pragma skip_variants FOG_EXP FOG_EXP2 // attempt to skip the fog keywords we dont want                     
            #pragma multi_compile_instancing
            #pragma instancing_options renderinglayer
    
            // Keywords
            //#pragma multi_compile_fragment _ _SCREEN_SPACE_OCCLUSION // We dont use SSO
            #pragma multi_compile _ LIGHTMAP_ON
            //#pragma multi_compile _ DYNAMICLIGHTMAP_ON // We dont use Dynamic lightmaps (enlighten)
            #pragma multi_compile _ DIRLIGHTMAP_COMBINED
            #pragma multi_compile _ _MAIN_LIGHT_SHADOWS _MAIN_LIGHT_SHADOWS_CASCADE _MAIN_LIGHT_SHADOWS_SCREEN
            #pragma multi_compile _ _ADDITIONAL_LIGHTS //_ADDITIONAL_LIGHTS_VERTEX // we dont use vertex lights
...
#define unity_WorldToObject GetWorldToObjectMatrix()
   ...
   SAMPLER(sampler_Layer1NormalMap);
    ...
    void Ext_ModifyVertex6 (inout VertexData v, inout ExtraV2F e)
	{
		// we use vertex color, but they won't be interpolated to the pixel shader. 
		e.extraV2F0 = v.vertexColor;
	}
   
	void Ext_SurfaceFunction6 (inout Surface o, inout ShaderData d)
    {
        o.Albedo = lerp(o.Albedo, o.Albedo * d.extraV2F0.rgb, _VertexColorIntensity);
        o.Occlusion = lerp(o.Occlusion, o.Occlusion * d.extraV2F0.a, _VertexColorIntensity);
    }
...
#define unity_WorldToObject GetWorldToObjectMatrix()
   ...
   #pragma fragment Frag
            ...
            #pragma exclude_renderers d3d11_9x
            #pragma multi_compile_instancing
            //#pragma multi_compile _ DOTS_INSTANCING_ON //we dont use DOTS
