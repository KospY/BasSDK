	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 appendResult11_g2800 = (float4(_TonemappingSettings.x , _TonemappingSettings.y , _TonemappingSettings.z , _TonemappingSettings.w));
				float4 settings2_g1 = appendResult11_g2800;
				...
				float3 color2_g1 = temp_output_8_0.xyz;
				float3 localApplyTonemapper2_g1 = ApplyTonemapper( settings2_g1 , color2_g1 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = localApplyTonemapper2_g1;
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1234.035,-803.4031;Inherit;True;Property;_TextureIntensity;Texture Intensity;6;0;Create;True;0;0;0;False;0;False;10;77.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;51;1438.31,-243.5524;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;59;1387.879,-329.012;Inherit;False;TonemappingNode;1;;1;305ac1d3fd2773448b8bd3815ea5531e;0;1;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;59;3;8;0
WireConnection;29;2;59;0
WireConnection;29;3;53;0
ASEEND*/
//CHKSM=F411A45FEA8C4EB84230D9FA93E1CFCC48BDF8FE