...
namespace ThunderRoad
{
    ...
    public class LightProbeVolumeGenerator : MonoBehaviour
    {
        ...
        [Tooltip("Horizontal and Vertical Factors to auto calculate texture resolution values.")]
        ...
        [Tooltip("Additive offset to be applied to the light probe size to be set on the box collider. Usually this will be negative so the box collider is smaller than the probe volume.")]
