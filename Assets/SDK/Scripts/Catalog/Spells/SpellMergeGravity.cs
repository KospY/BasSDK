...
namespace ThunderRoad
{
    ...
    public class SpellMergeGravity : SpellMergeData
    {
...
#if ODIN_INSPECTOR
        [BoxGroup("Bubble"), ValueDropdown("GetAllEffectID")] 
#endif
        ...
        public override void OnCatalogRefresh()
        {
            ...
            if (throwEffectId != null && throwEffectId != "") throwEffectData = Catalog.GetData<EffectData>(throwEffectId);
            if (bubbleEffectId != null && bubbleEffectId != "") bubbleEffectData = Catalog.GetData<EffectData>(bubbleEffectId);
