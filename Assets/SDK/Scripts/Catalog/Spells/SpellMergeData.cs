...
namespace ThunderRoad
{
    ...
    {
#if ODIN_INSPECTOR
        [BoxGroup("Merge"), ValueDropdown("GetAllSpellID")]
#endif
        [JsonMergeKey]
        ...
        [BoxGroup("Merge")]
#endif
        public AnimationCurve hapticIntensityCurve = new Utils.CurveBuilder()
            .WithKey(0, 0)
            .WithKey(0.83f, 0.4f)
            .WithKey(0.86f, 0)
            .WithKey(0.89f, 0)
...
#if ODIN_INSPECTOR
        [BoxGroup("Merge"), ValueDropdown("GetAllEffectID")]
#endif
