...
namespace ThunderRoad
{
    ...
    public class HandleRagdollData : HandleData
    {
		...
		[BoxGroup("Ragdoll/Lift")]
#endif
		public bool liftSpinningFix = true; // Fixes the TK spin, just in case it might break stuff, easy to disable 
        #if ODIN_INSPECTOR
		[BoxGroup("Ragdoll/Lift")]
#endif
		public bool LiftLockCharJointLimits= true; // Fixes the TK spin, just in case it might break stuff, easy to disable 
