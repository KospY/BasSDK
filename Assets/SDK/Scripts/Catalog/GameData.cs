...
namespace ThunderRoad
{
    ...
    public class GameData
    {
        ...
        public string pointerMeshAddress = "DefaultPointerMesh";
        ...
        public class CategoryGroup
        {
            ...
            [NonSerialized]
            public Category[] LinkedCategories;
            ...
            public bool IsInvalid() => InvalidCategoryGroup.id == id || string.IsNullOrEmpty(id);
        ...
        public GameInventory.Data inventoryData;
        ...
        public string playerMenuPrefabAddress;
