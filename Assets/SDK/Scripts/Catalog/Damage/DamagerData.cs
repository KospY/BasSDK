...
namespace ThunderRoad
{
    ...
    {
#if ODIN_INSPECTOR
        [BoxGroup("General"), ValueDropdown("GetAllDamagerModifierID")] 
#endif
...
#if ODIN_INSPECTOR
        [BoxGroup("Split/Left/Bad angle"), ValueDropdown("GetAllDamagerModifierID"), ShowIf("badAngleBluntFallback")] 
#endif
        ...
        public override void OnCatalogRefresh()
        {
            ...
            if (damageModifierId != null && damageModifierId != "") damageModifierData = Catalog.GetData<DamageModifierData>(damageModifierId);
            if (badAngleMaterialDamageId != null && badAngleMaterialDamageId != "") badAngleModifierData = Catalog.GetData<DamageModifierData>(badAngleMaterialDamageId);
        }
    }
}
