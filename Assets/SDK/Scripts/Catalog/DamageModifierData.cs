...
namespace ThunderRoad
{
    ...
    public class DamageModifierData : CatalogData
    {
        ...
        public override void OnCatalogRefresh()
        {
            ...
            {
                collision.damagerModifierData = this;
                collision.OnCatalogRefresh();
            }
            defaultModifier = new Modifier();
            defaultModifier.damagerModifierData = this;
            defaultModifier.minVelocity = Mathf.Infinity;
            defaultModifier.damageMultiplier = 0;
        }
        ...
        public class Collision
        {
            ...
            {
                sourceMaterials = new List<MaterialData>();
                foreach (string materialId in sourceMaterialIds)
                {
                    MaterialData materialData = Catalog.GetData<MaterialData>(materialId);
                    if (materialData != null) sourceMaterials.Add(materialData);
                }
                ...
                {
                    modifier.collision = this;
                    modifier.damagerModifierData = damagerModifierData;
                }
            }
