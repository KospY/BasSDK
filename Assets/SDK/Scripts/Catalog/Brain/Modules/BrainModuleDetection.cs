...
namespace ThunderRoad
{
    ...
    {
        public static bool showDetectionDebugs = false;
        public static Color undetectedColor = new(0, 1, 0, 0.5f);
        public static Color detectedColor = new(1, 0, 0, 0.5f);
        [Header("Sight")]
        ...
        public float ignoreTouchByRagdollChance = 0f;
        public float holsterIgnoreTouchChance = 1f;
        public float ignoreTouchByItemChance = 0.1f;
        public Vector2 minMaxTouchReactDelay = new Vector2(0f, 0.1f);
        public float pickpocketDetectionChance = 1f;
