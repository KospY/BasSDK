...
namespace ThunderRoad
{
    ...
    public class CreatureData : CatalogData
    {
...
#if ODIN_INSPECTOR
        [BoxGroup("General"), ValueDropdown("GetAllFactionID")] 
#endif
...
#if ODIN_INSPECTOR
        [BoxGroup("AI"), ValueDropdown("GetAllBrainID")] 
#endif
...
#if ODIN_INSPECTOR
        [TabGroup("Audio"), ValueDropdown("GetAllEffectID")] 
#endif
...
#if ODIN_INSPECTOR
        [TabGroup("Audio"), ValueDropdown("GetAllVoiceID")] 
#endif
        ...
        public class EthnicGroup
        {
            ...
            [NonSerialized] public Material bodyMaterialLod0;
            [NonSerialized] public Material bodyMaterialLod1;
            [NonSerialized] public Material handsMaterialLod0;
            [NonSerialized] public Material handsMaterialLod1;

#if ODIN_INSPECTOR
            [BoxGroup("Custom Parts")]
            [ValueDropdown("GetAllHeadsId")]  
#endif
            ...
            public List<ValueDropdownItem<string>> GetAllHeadsId()
            {
                ...
                foreach (var catalogData in Catalog.GetDataList(Category.Item).Where(i => i is ItemData))
                {
                    ...
                    if (itemModuleWardrobe != null && itemModuleWardrobe.category == Equipment.WardRobeCategory.Body)
                    {
                        ...
                        {
                            if (creatureWardrobe != null && creatureWardrobe.manikinWardrobeData != null
...
#if ODIN_INSPECTOR
        [TabGroup("Expression"), ValueDropdown("GetAllExpressionId")] 
#endif
...
#if ODIN_INSPECTOR
        [TabGroup("Water"), ValueDropdown("GetAllEffectID")] 
#endif
