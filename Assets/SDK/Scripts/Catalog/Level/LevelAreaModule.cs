...
namespace ThunderRoad
{
    public class LevelAreaModule : LevelModule
    {
        ...
        {
#if ODIN_INSPECTOR
            [ValueDropdown("GetAllAreaCollectionID")]
#endif
        ...
        public int areaSpawnDepth = 100;
        public int areaDespawnDepth = 100;
        public int areaCullDepth = 2;

        public List<List<AreaSpawnerData>> listAreaByLengthAndDifficulty;
