...
namespace ThunderRoad
{
    ...
    public class AssetData<T> where T : UnityEngine.Object
    {
        ...
        public class Reference : AssetObjectReference
        {
            ...
            public bool bakeLightProbeVolume;
            public bool bakeNavmesh;
            public bool bakeFakeViews;
            
            public State bakeLightmapsState = State.None;
            public State bakeCullingState = State.None;
			public State bakeLightProbeVolumeState = State.None;
            public State bakeNavmeshState = State.None;
            public State bakeFakeViewsState = State.None;
        ...
        public bool NeedCompute()
        {
            return androidExport
             || defaultReference.bakeLightmaps || defaultReference.bakeCulling || defaultReference.bakeLightProbeVolume || defaultReference.bakeNavmesh || defaultReference.bakeFakeViews
             || androidReference.bakeLightmaps || androidReference.bakeCulling || androidReference.bakeLightProbeVolume || androidReference.bakeNavmesh || androidReference.bakeFakeViews;
        }
    }
