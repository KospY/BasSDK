...
public class ReflectionSorcery : MonoBehaviour
{
    ...
    [Space(10)] [Range(0, 1)] public float fade = 1;

    [Space(10)] [SerializeField] private List<PassRotationMatrix> rsRenderers = new List<PassRotationMatrix>();
    ...
    private void UpdateMaterials()
    {
        ...
        {
            if (passRotationMatrix == null) continue;
            if (passRotationMatrix.matBlock == null) passRotationMatrix.matBlock = new MaterialPropertyBlock();
    ...
    [Space(10)] public Vector3 capturePosition = new Vector3(0, 1.5f, 0);
