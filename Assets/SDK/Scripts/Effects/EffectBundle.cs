...
namespace ThunderRoad
{
    ...
    {
#if ODIN_INSPECTOR
        [ValueDropdown(nameof(GetAllEffectID)), HideLabel, HorizontalGroup("Effect", 0.5f)] 
#endif
...
#if ODIN_INSPECTOR
        [ValueDropdown(nameof(GetAllEffetModuleTypes)), LabelText("Ignored module(s)"), HorizontalGroup("Effect")] 
#endif
