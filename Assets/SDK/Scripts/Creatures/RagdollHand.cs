...
namespace ThunderRoad
{
    ...
    public class RagdollHand : RagdollPart
    {
        ...
        public event PunchEvent OnPunchStartEvent;
        public event PunchEvent OnPunchEndEvent;


        [NonSerialized]
        public bool fingerMeshParentedToAnim;
        [NonSerialized]
        public bool tempIgnoreOverlap = false;
        ...
        public delegate void ControlPoseChangeEvent(Side side, ControlPose previousPose, ControlPose newPose);
        public event ControlPoseChangeEvent OnControlPoseChangeEvent;
