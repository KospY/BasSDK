...
namespace Needle.ShaderGraphMarkdown
{
    public abstract class MarkdownMaterialPropertyDrawer : ScriptableObject
    {
        ...
        /// <summary>
        /// Override this and return true to continue to draw the orignal reference property, eg if it was a Texture field, continue to draw that AND the new one specified by your drawer
        /// </summary>
        public virtual bool ReplaceOriginal()
        {
            return true;
        }
    }
