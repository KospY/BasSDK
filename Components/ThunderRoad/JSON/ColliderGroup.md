...
A ColliderGroup JSON is used to determine imbues and weapon tiers. This is referenced in the "ColliderGroups" section of the Item JSON. Different collider groups have different settings related to each of their tier. The tier is set in in the "tier" of the item.

| Keys                          | Description |
| ---                           | --- |
| id                            | The unique ID for the ColliderGroup |
...
| imbueFeatures \[Flags\]       | <details>- Slam<br>- Use<br>- Steal</details>
