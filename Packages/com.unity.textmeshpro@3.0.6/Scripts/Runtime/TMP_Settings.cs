...
namespace TMPro
{
    ...
    public class TMP_Settings : ScriptableObject
    {
        ...
        {
            get { return instance != null ? instance.m_defaultStyleSheet : null; }
        }
        [SerializeField]
        ...
        public static TMP_Settings instance
        {
            get
            {
                if (TMP_Settings.s_Instance == null)
                {
                    ...
                    TMP_Settings.s_Instance = TMP_ResourceLoader.LoadSettings();
        ...
        public static TMP_Settings LoadDefaultSettings()
        {
            if (s_Instance == null)
            {
                ...
                TMP_Settings settings = TMP_ResourceLoader.LoadSettings();
                if (settings != null)
                    s_Instance = settings;
            }
