                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 28511: // <FONT>
                        ...
                        if (tempFont == null)
                        {
                            ...
                            if (tempFont == null)
                            {
                                ...
                                tempFont = TMP_ResourceLoader.LoadFontAsset(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                            }
                        ...
                        else if (materialAttributeHashCode == 103415287 || materialAttributeHashCode == 72669687) // using material attribute
                        {
                            ...
                            else
                            {
                                ...
                                tempMaterial = TMP_ResourceLoader.LoadMaterial(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[1].valueStartIndex, m_xmlAttribute[1].valueLength));
                    ...
                    case 72669687: // <MATERIAL>
                        ...
                        else
                        {
                            ...
                            tempMaterial = TMP_ResourceLoader.LoadMaterial(TMP_Settings.defaultFontAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                    ...
                    case 69403544:  // <GRADIENT>
                        ...
                        else
                        {
                            ...
                            if (tempColorGradientPreset == null)
                            {
                                ...
                                tempColorGradientPreset = TMP_ResourceLoader.LoadColorGradient(TMP_Settings.defaultColorGradientPresetsPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                            }
                        ...
                        if (m_xmlAttribute[0].valueType == TagValueType.None || m_xmlAttribute[0].valueType == TagValueType.NumericalValue)
                        {
                            ...
                            else if (m_defaultSpriteAsset == null)
                            {
                                if (TMP_Settings.defaultSpriteAsset != null)
                                    ...
                                    m_defaultSpriteAsset = TMP_ResourceLoader.LoadSpriteAsset("Sprite Assets/Default Sprite Asset");
                            ...
                            else
                            {
                                ...
                                if (tempSpriteAsset == null)
                                {
                                    ...
                                    if (tempSpriteAsset == null)
                                        ...
                                        tempSpriteAsset = TMP_ResourceLoader.LoadSpriteAsset(TMP_Settings.defaultSpriteAssetPath + new string(m_htmlTag, m_xmlAttribute[0].valueStartIndex, m_xmlAttribute[0].valueLength));
                                }
